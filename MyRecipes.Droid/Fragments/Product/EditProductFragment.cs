...
namespace MyRecipes.Droid.Fragments.Product
{
    ...
    [Register("myrecipes.droid.fragments.product.EditProductFragment")]
    public class EditProductFragment : BaseFragment<EditProductViewModel>
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            ((MainActivity)Activity).Title = "Редактирование продукта";
        ...
        protected override int FragmentId => Resource.Layout.fragment_edit_product;
    }
}