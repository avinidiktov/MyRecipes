...
namespace MyRecipes.Droid.Fragments.Dish
{
    ...
    [Register("myrecipes.droid.fragments.dish.AddNewDishFragment")]
    public class AddNewDishFragment : BaseFragment<AddNewDishViewModel>
    {
        ...
        protected override int FragmentId => Resource.Layout.fragment_add_new_dish;
    }
}